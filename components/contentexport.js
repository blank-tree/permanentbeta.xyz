	...
	render() {
		return(
			<article>
				...
				<p>I'm going on an adventure by my own choosing, to think and write about the landscape we're currently<sup><a href="#fn1-13935" id="fnr1-13935" title="see footnote" class="footnote">1</a></sup> in and the changes to our collective way of thinking about ourselves and the society<sup><a href="#fn2-13935" id="fnr2-13935" title="see footnote" class="footnote">2</a></sup> we're part of.
				Thinking back, the last two decades marked a drastically shift in the ways individuals and groups communicate with each other in a modern world. The expectation that everyone around us knows how to use (and misuse) the new tools of communication and information seem to unearth the ambiguity of the underlying concepts. With the implementation of this ambiguity into fixed systems – built by private companies – our society also seems to lose the agency to advance them in the future. This is a pessimistic view of <a href="https://en.wikipedia.org/wiki/Digitization">digitization</a> and falls in line with the way of thinking of the <a href="https://en.wikipedia.org/wiki/Swing_Riots">Swing Riots in the 1830s</a>. One could think with the rhetoric used in news articles<sup><a href="#fn3-13935" id="fnr3-13935" title="see footnote" class="footnote">3</a></sup> discussing pitfalls and setbacks – from the point of view of companies working in these fields – that an <a href="https://en.wikipedia.org/wiki/Orwellian">&quot;Orwellian Dystopia&quot;</a> is the only logical outcome. A worrying outlook, but in my humble opinion is this not the entire story and much of it is still in our – individual and collective – hands.<br/>
				...
				<p>The description Foucault provided seems to be fitting to a romantic description of the internet over forty years before it became part of our everyday life. One could argue, that the internet isn't &quot;real&quot; and only exists in a form of interpretation and translation an isn't bound to a physical space<sup><a href="#fn5-13935" id="fnr5-13935" title="see footnote" class="footnote">5</a></sup> like ships or brothels, but to a certain extent the same specifications Foucault describes seem to fit to the world wide web.</p>
				...
				<li id="fn1-13935">
				<p>which is – when this project works in the intended way – now and in the future <a href="#fnr1-13935" title="return to article" class="reversefootnote">&#8617;&#xFE0E;</a></p>
				</li>

				<li id="fn2-13935">
				<p>In my case right now: the German speaking part of Switzerland in April 2019 <a href="#fnr2-13935" title="return to article" class="reversefootnote">&#8617;&#xFE0E;</a></p>
				</li>

				<li id="fn3-13935">
				<p>like the <a href="https://en.wikipedia.org/wiki/Cambridge_Analytica">Facebook–Cambridge Analytica data scandal 2018</a>, the leaks surrounding <a href="https://en.wikipedia.org/wiki/Global_surveillance_disclosures_(2013%E2%80%93present)">surveilance</a> which are on an all time high since the <a href="https://en.wikipedia.org/wiki/Edward_Snowden#Global_surveillance_disclosures">Snowden leaks in 2013</a>, the list is long... <a href="#fnr3-13935" title="return to article" class="reversefootnote">&#8617;&#xFE0E;</a></p>
				</li>

				<li id="fn4-13935">
				<p>a <a href="https://en.wikipedia.org/wiki/Version_control">version control system</a> used and misused by programmers all over the world for sharing and collaborating on a variety of code based projects <a href="#fnr4-13935" title="return to article" class="reversefootnote">&#8617;&#xFE0E;</a></p>
				</li>

				<li id="fn5-13935">
				<p>at least, not anymore since the era of the &quot;internet cafes&quot; died in the early 2000s <a href="#fnr5-13935" title="return to article" class="reversefootnote">&#8617;&#xFE0E;</a></p>
				</li>
