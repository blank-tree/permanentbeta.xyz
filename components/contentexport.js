	...
	render() {
		return(
			...
			<p>&quot;There are also, probably in every culture, in every civilization, real places—places that do exist and that are formed in the very founding of society—which are something like counter-sites, a kind of effectively enacted utopia in which the real sites, all the other real sites that can be found within the culture, are simultaneously represented, contested, and inverted. Places of this kind are outside of all places, even though it may be possible to indicate their location in reality. Because these places are absolutely different from all the sites that they reflect and speak about, I shall call them, by way of contrast to utopias, heterotopias.&quot;<br/>
			 <em>Michel Foucault 1967</em><sup><a href="#fn5-23958" id="fnr5-23958" title="see footnote" className="footnote">5</a></sup></p>
			</blockquote>
			...
			<p>The description Foucault provides fits a romantic description of the internet for the forty years before it became part of our everyday life. One could argue that the internet isn't &quot;real&quot; and only exists as a form of interpretation and translation and isn't bound to a physical space<sup><a href="#fn6-23958" id="fnr6-23958" title="see footnote" className="footnote">6</a></sup> like Foucault's ships or brothels. The way that people and the media refer to the &quot;digital space&quot; reveals an underlying misapprehension that we could escape from or ignore this space.</p>
			...
			<br/>
			<em>Michel Foucault 1967</em><sup><a href="#fn7-23958" id="fnr7-23958" title="see footnote" className="footnote">7</a></sup></p>
			</blockquote>

			<p>The submission to these new forms of communication is becoming a requirement to stay relevant within society, with jobs requiring digital application in fields which do not require this specific skillset in their practice. To a certain extent, the ability to navigate through the digital forms of communication and interaction became the new centerpiece our education, which is concerned with and struggling to give people the means to comprehend our world. But education favors the usage and not understanding of or reflection on these &quot;tools&quot;. If we submit to these new forms of communication, we are actively dividing our society into &quot;users of technology&quot; and &quot;absentees&quot;. The threshold one has to overcome to communicate with someone for longer than just a few interactions in person <strong>without</strong> – for example – a smartphone<sup><a href="#fn8-23958" id="fnr8-23958" title="see footnote" className="footnote">8</a></sup> or availability through instant messaging or e-mail, is higher with someone who's using these tools like you right now. Maybe we are constantly peer-pressuring other people – without specifically intending to do so – to join our digital heterotopia of efficiency<sup><a href="#fn9-23958" id="fnr9-23958" title="see footnote" className="footnote">9</a></sup>.<br/>
			So maybe the compulsory &quot;feeling&quot; that arises, that you're &quot;missing out&quot; when you're not part of this digital &quot;revolution&quot;, forces us to define a position towards this digital space. I argue that the individual choice one makes isn't the interesting thing, but the nature of our time that becomes part of our everyday discourse of having to <em>make</em> a choice how one stands in the digital space.<br/>
			...
			<p>The translation of man-made concepts and systems into a computer system requires the hard choice of determining what an analogue value is as a digital one. 1s and 0s. Not every system we have in place can to be abstracted in such a form, and even though a few of them can be, there are the problems of man-made systems of responsibility and agency even in seemingly easy examples hard to pin down:</p>
			...
			<em>Matt Webb, 2012</em><sup><a href="#fn11-23958" id="fnr11-23958" title="see footnote" className="footnote">11</a></sup></p>
			</blockquote>

			<p>Webb talks about designers here but the comparison to programmers is not far fetched, as the two professions deal with the same problems at hand, abstraction and translation into something people without the required knowledge <em>could</em> understand and use. So the question becomes rather than just a practical one of <em>how</em> one can convey the necessary information also one of ethics and of how one <em>should</em> convey the information. Each and every designed artefact isn't an &quot;objective&quot; representation of <em>what is needed</em> but the subjective understanding of its creators. </p>
			...
			<p>The level of complexity far overreaches the capacity of our understanding of how society and nature operate. But the belief in this vision, of a model to regulate and comprehend the world weare in lead to a &quot;trust&quot; in machines, which they will never be able to fulfill. A machine or system can never exceed its creators in their vision, only in efficiency, and this efficiency only scales the subjective understanding its creators have put into it and can't eradicate it<sup><a href="#fn14-23958" id="fnr14-23958" title="see footnote" className="footnote">14</a></sup>. But this misled trust in these &quot;neutral&quot; and &quot;objective&quot; machines averts the fact that they will never be able to &quot;solve&quot; our social challenges, which we will have to carry out ourselves now and in the future while these biased machines can only be what they were before: tools or an enhancement:</p>
			...
			<em>Nick Bostrom, 2007</em><sup><a href="#fn15-23958" id="fnr15-23958" title="see footnote" className="footnote">15</a></sup></p>
			</blockquote>

			<p>Maybe we're just following our system of hearing what we want to hear and only created a new terminology with the &quot;filter-bubble&quot; to escape responsibility.</p>
			...
			<p>Various science fiction writers described utopian or dystopian worlds in which society is deprived of reflection on their guiding systems. In Aldous Huxley's &quot;Brave New World&quot;<sup><a href="#fn17-23958" id="fnr17-23958" title="see footnote" className="footnote">17</a></sup> the members of society pressure each other to take the happiness-inducing drug &quot;soma&quot;. When one compares this drug to the pressure of availability and representation on social media platforms like Facebook and Instagram on which everyone is happy, everyone is successful and everyone is doing great things in their individual lives, it becomes clear that we are already doing the same thing. We force upon our individual selves the pressure of capitalization and quantification of each and every aspect of our lives, to show our peers that we're worth the &quot;social capital&quot; that we represent. But the dissonance between our presented selves and how – we think – we are is an age-old discussion in sociology and psychology of how we perceive ourselves. Social media gives us the means to do this in an orderly and structured fashion. You have the same amount of space as everyone else to fill up with as many things as you see fit to &quot;correctly&quot; show us who you actually are – or would like us to believe you are.</p>

			<p>In his book &quot;Alienation and Acceleration&quot;<sup><a href="#fn18-23958" id="fnr18-23958" title="see footnote" className="footnote">18</a></sup>, Hartmut Rosa argues that the promise of the moderne era is the autonomy to decide – individually and collectively – what self-determination is. <em>Who we are</em> and <em>how we want to live</em>. But this aim toward autonomy is clouded by the rising alienation and acceleration (the title of his book) we developed alongside. He further describes this situation as a &quot;competitive-society&quot;, in which the highest aim is to be happier than your peers, in which the sole goal is to like and not to reflect, where the end justifies the means and one superlative overthrows the next. In this situation, who you are cannott always be represented in a system in which the only reaction is a &quot;like&quot; and the separation between who you are online and in the physical world becomes inevitable.</p>
			...
			<em>Gilles Deleuze, 1992</em><sup><a href="#fn19-23958" id="fnr19-23958" title="see footnote" className="footnote">19</a></sup></p>
			</blockquote>

			<p>And we're discovering first hand what our &quot;marketing of the self&quot; is creating. A society in permanent dependency to reactions through arbitrary feedback which isn't able to replace inter-human-interaction.</p>
			...
			<em>Adam Greenfield, 2017</em><sup><a href="#fn20-23958" id="fnr20-23958" title="see footnote" className="footnote">20</a></sup></p>
			</blockquote>
			...
			<li id="fn1-23958">
			<p>which is – when this project works in the intended way – now and in the future <a href="#fnr1-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>

			<li id="fn2-23958">
			<p>In my case right now: the German speaking part of Switzerland in April 2019 <a href="#fnr2-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>
			...
			<li id="fn6-23958">
			<p>at least, not since the era of the &quot;internet cafes&quot; died in the early 2000s <a href="#fnr6-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>
			...
			<li id="fn8-23958">
			<p>this is going to be crucial to update in the future! Who knows when the next thing will take over... <a href="#fnr8-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>

			<li id="fn9-23958">
			<p>The fact that you're reading this right now on a website, in a browser, on a device (like a computer or a smartphone) implies that you're at least to a certain extent part of this <a href="#fnr9-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>
			...
			<li id="fn12-23958">
			<p><a href="https://courses.ischool.berkeley.edu/i290-tpl/s11/w/images/6/69/The_Moral_Dilemmas_of_a_Safety-belt.pdf">Bruno Latour, 1989. <em>The Moral Dilemmas of a Safety-belt</em> from: La Ceinture de sécurité”, in Alliage N°1 p.21-27. Traduction inédite en anglais, unpublished English translation by Lydia Davis</a>, p. 6 <a href="#fnr12-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>

			<li id="fn13-23958">
			<p><a href="https://vimeo.com/300725472">Adam Curtis, 2016. <em>All Watched Over by Machines of Loving Grace - Episode 2 - The Use and Abuse of Vegetational Concepts</em>, BBC</a>, 28:00 – 36:05 <a href="#fnr13-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>

			<li id="fn14-23958">
			<p>Like the many times programs operated by <a href="https://en.wikipedia.org/wiki/Machine_learning">&quot;machine learning&quot;</a> – to which people often falsely refer to as <a href="https://en.wikipedia.org/wiki/Artificial_intelligence">&quot;A.I.&quot;</a> – created <a href="https://www.theverge.com/2016/3/24/11297050/tay-microsoft-chatbot-racist">racist</a> or <a href="https://www.technologyreview.com/s/612876/this-is-how-ai-bias-really-happensand-why-its-so-hard-to-fix/">biased</a> outcomes <a href="#fnr14-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>

			<li id="fn15-23958">
			<p><a href="https://nickbostrom.com/ethics/dignity-enhancement.pdf">Nick Bostrom, 2007. <em>Dignity and Enhancement</em></a>, p. 30 <a href="#fnr15-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>

			<li id="fn16-23958">
			<p><a href="https://vimeo.com/191817381">Adam Curtis, 2016. <em>HyperNormalisation</em>, BBC</a>, 23:26 – 26:55 <a href="#fnr16-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>

			<li id="fn17-23958">
			<p>Huxley, Aldous, 1931. <em>Brave new world</em>, New York: Everyman's Library. <a href="#fnr17-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>

			<li id="fn18-23958">
			<p>Hartmut Rosa, 2010. <em>Alienation and Acceleration: Towards a Critical Theory of Late-Modern Temporality</em>, Aarhus University Press <a href="#fnr18-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>

			<li id="fn19-23958">
			<p>Gilles Deleuze, 1992. <a href="https://cidadeinseguranca.files.wordpress.com/2012/02/deleuze_control.pdf"><em>Postscript on the Societies of Control</em></a>, MIT-Press, p. 7 <a href="#fnr19-23958" title="return to article" className="reversefootnote">&#8617;&#xFE0E;</a></p>
			</li>
